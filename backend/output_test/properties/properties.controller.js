...
let PropertiesController = class PropertiesController {
    ...
    async create(user, listingId, createPropertyDto) {
        return this.propertiesService.create(user.id, listingId, createPropertyDto);
    }
    async update(user, listingId, updatePropertyDto) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Add property details to a listing' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('listingId')),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, dto_1.CreatePropertyDto]),
...
__decorate([
    ...
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, dto_1.UpdatePropertyDto]),
    __metadata("design:returntype", Promise)
], PropertiesController.prototype, "update", null);
__decorate([
    (0, common_1.Get)(':listingId'),
    (0, swagger_1.ApiOperation)({ summary: 'Get property details by listing ID' }),
    __param(0, (0, common_1.Param)('listingId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], PropertiesController.prototype, "findByListingId", null);
