...
let FirebaseProvider = FirebaseProvider_1 = class FirebaseProvider {
    configService;
    logger = new common_1.Logger(FirebaseProvider_1.name);
    app;
    adminApp;
    ...
    initializeFirebase() {
        try {
            const firebaseConfig = {
                ...
                measurementId: this.configService.get('firebase.measurementId'),
            };
...
exports.FirebaseProvider = FirebaseProvider = FirebaseProvider_1 = __decorate([
