    ...
    <div className="flex flex-1 flex-col gap-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {listings.length} total listing{listings.length !== 1 ? "s" : ""} in
            your portfolio
          </p>
        </div>
        <Link
          href="/pages/broker/listings/create"
          className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-[10px] font-semibold text-sm transition-all shadow-md shadow-blue-600/20"
        >
      ...
      {loading ? (
        viewMode === "grid" ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div
                key={i}
                className="bg-card border rounded-[10px] overflow-hidden animate-pulse"
              >
        ...
        <div className="text-center py-16">
          ...
          <h3 className="font-bold text-lg mb-1">Failed to load listings</h3>
        ...
        <div className="text-center py-16">
          ...
          {listings.length === 0 && (
            <Link
              href="/pages/broker/listings/create"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white rounded-[10px] text-sm font-semibold hover:bg-blue-700 shadow-md shadow-blue-600/20"
            >
                  ...
                  <div className="absolute bottom-3 right-3">
                    ...
                    {menuId === l.id && (
                      <div className="absolute bottom-full right-0 mb-1 bg-card border border-border rounded-[10px] shadow-xl py-1 min-w-[140px] z-10">
                        <Link
                          href={`/pages/broker/listings/${l.id}/edit`}
                  ...
                  {l.property && (
                    <div className="flex flex-wrap gap-1.5">
                      ...
                      {l.property.bathrooms != null && (
                        <span className="px-2 py-0.5 bg-muted rounded-md text-[10px] font-semibold">
                          {l.property.bathrooms} Bath
                        </span>
                      )}
                      {l.property.squareMeters != null && (
                        <span className="px-2 py-0.5 bg-muted rounded-md text-[10px] font-semibold">
                          {l.property.squareMeters} m²
                        </span>
                      )}
                      {l.property.furnished && (
                ...
                {filtered.map((l) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="p-4">
                        <span
                          className={`px-2.5 py-1 rounded-[10px] text-[10px] font-bold ${statusColors[l.status] || statusColors.DRAFT}`}
                        >
                          {statusLabels[l.status] || l.status}
                        </span>
                      </td>
                      <td className="p-4 pr-5">
                        <div className="flex items-center justify-end gap-1">
                          <Link
                            href={`/pages/broker/listings/${l.id}/edit`}
                            className="p-2 rounded-[10px] text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-950/30 transition-colors"
                            title="Edit"
                          >
                          ...
                          {l.status === "DRAFT" && (
                            <button
                              onClick={() => handleSubmitForReview(l.id)}
                              className="p-2 rounded-[10px] text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-950/30 transition-colors"
