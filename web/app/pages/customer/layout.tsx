...
const pageTitles: Record<string, string> = {
  ...
  "/pages/customer/search": "Search & Inquire Properties",
  "/pages/customer/favorites": "My Saved Favorites",
  "/pages/customer/bookings": "Viewing Appointments",
  "/pages/customer/messages": "Messages & Inquiries",
  "/pages/customer/settings": "Account Settings",
};
...
export default function CustomerLayout({ children }: { children: ReactNode }) {
  ...
  const { user } = useAuth();
  const name =
    user?.profile?.firstName || user?.email?.split("@")[0] || "Customer";
