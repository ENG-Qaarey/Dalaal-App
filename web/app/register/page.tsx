...
const roleOptions: RoleOption[] = [
  {
    value: "CUSTOMER",
    label: "Customer",
    desc: "Browse, rent, or buy properties and vehicles.",
    icon: <UserCircle className="w-5 h-5" />,
  },
  {
    value: "PROPERTY_OWNER",
    label: "Property Owner",
    desc: "List and manage your real estate assets.",
    icon: <HomeIcon className="w-5 h-5" />,
  },
  {
    value: "VEHICLE_OWNER",
    label: "Vehicle Owner",
    desc: "Post cars, trucks, and rental fleet listings.",
    icon: <Car className="w-5 h-5" />,
  },
  {
    value: "REGULAR_DALAAL",
    label: "Dalaal / Broker",
    desc: "Act as a licensed or freelance property agent.",
...
export default function RegisterPage() {
  ...
  const validate = () => {
    ...
    if (!phone) newErrors.phone = "Phone number is required";
      ...
      newErrors.phone = "Enter a valid phone (e.g. +252612345678)";
        ...
        <div className="relative z-10 w-full max-w-lg">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-2">
              Join the trusted marketplace for properties and vehicles in
              Somalia.
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className={`w-full h-11 px-4 bg-zinc-50 dark:bg-zinc-950 border rounded-xl text-sm font-medium focus:outline-none focus:ring-2 transition-all ${
                      errors.lastName
                        ? "border-red-400 focus:ring-red-500/30"
                        : "border-zinc-200 dark:border-zinc-800 focus:ring-sky-500/30"
                    }`}
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-[10px] text-zinc-400">
                  Used for EVC Plus / ZAAD / SAHAL verification.
                </p>
              </div>
                  ...
                  {roleOptions.map((opt) => (
                    <button
                      ...
                      className={`p-3.5 rounded-xl border text-left transition-all duration-200 ${
                        role === opt.value
                          ? "bg-sky-50 dark:bg-sky-950/30 border-sky-300 dark:border-sky-800 ring-2 ring-sky-500/20"
                    ...
                    >
                      ...
                      <div className="text-[10px] text-zinc-500 dark:text-zinc-400 mt-0.5 leading-relaxed">
                        {opt.desc}
                      </div>
                    </button>
                  ))}
              ...
              <div className="space-y-1.5">
                <div className="flex items-start gap-2.5">
                  ...
                  <span className="text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed">
                    ...
                    <Link
                      href="/terms"
                      className="font-bold text-sky-600 hover:text-sky-700 dark:text-sky-400 underline"
                    >
                      Terms of Service
                    </Link>{" "}
                    and{" "}
                    ...
                    , including escrow transaction data processing.
                  </span>
                </div>
                {errors.terms && (
                  <p className="text-[11px] text-red-500 font-semibold pl-6">
                    {errors.terms}
                  </p>
                )}
              </div>
