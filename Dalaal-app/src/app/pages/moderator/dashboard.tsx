...
const STAT_CARDS = [
  { id: 'reviews', title: 'Pending Reviews', subtitle: 'Listings to review', icon: 'eye', color: '#3b82f6', value: '0' },
  { id: 'flagged-users', title: 'Flagged Users', subtitle: 'Users needing review', icon: 'people', color: '#ef4444', value: '0' },
  { id: 'flagged', title: 'Flagged Listings', subtitle: 'Listings to moderate', icon: 'flag', color: '#f59e0b', value: '0' },
  { id: 'reports', title: 'Reports', subtitle: 'Submitted by users', icon: 'document-text', color: '#8b5cf6', value: '0' },
];
    ...
    <SafeAreaView style={[styles.safe, { backgroundColor: C.surface }]} edges={['top']}>
      ...
      <View style={[styles.header, { paddingTop: insets.top }]}>
        ...
        <View style={styles.headerTextWrap}>
          <Text style={[styles.headerTitle, { color: C.textMain }]}>Moderator Dashboard</Text>
      ...
      <ScrollView contentContainerStyle={[styles.content, { paddingBottom: insets.bottom + 20 }]} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.actionsRow}>
          <TouchableOpacity activeOpacity={0.85} style={[styles.actionBtn, { backgroundColor: C.brandBlue }]}>
            <Ionicons name="checkmark-circle" size={24} color={C.surface} />
            <Text style={[styles.actionText, { color: C.surface }]}>Review Queue</Text>
          </TouchableOpacity>
          <TouchableOpacity activeOpacity={0.85} style={[styles.actionBtn, { backgroundColor: C.tableRow, borderColor: C.brandBorder, borderWidth: 1 }]}>
            <Ionicons name="flag" size={24} color={C.brandOrange} />
            <Text style={[styles.actionText, { color: C.textMain }]}>Flagged Items</Text>
          </TouchableOpacity>
        </View>
