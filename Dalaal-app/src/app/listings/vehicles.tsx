...
const MOCK_VEHICLES = [
  { id: '2', price: '$35,000', title: 'Toyota Land Cruiser', location: 'Waberi', year: 2020, agent: 'Fatima', posterRole: 'Owner', posterVerified: false, posterRating: '4.7', image: 'https://images.unsplash.com/photo-1549399542-7e3f8b5b3f32?auto=format&fit=crop&w=1200&q=80' },
  { id: 'v1', price: '$28K', title: 'Hilux', agent: 'Ali', posterRole: 'Dealer', posterVerified: false, posterRating: '4.6', image: 'https://images.unsplash.com/photo-1494976388531-d1058494cdd8?auto=format&fit=crop&w=1200&q=80' },
  { id: 'v2', price: '$42K', title: 'Patrol', agent: 'Amina', posterRole: 'Dealer', posterVerified: true, posterRating: '4.8', image: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=1200&q=80' },
];
  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: C.surface }]} edges={['left', 'right']}>
      <View style={[styles.header, { paddingTop: insets.top, borderBottomColor: C.brandBorder }]}>
        ...
        <Text style={[styles.title, { color: C.textMain }]}>Vehicles</Text>
      </View>
        ...
        {MOCK_VEHICLES.map((item) => (
          ...
          >
            ...
            <View style={styles.cardBody}>
              ...
              {item.year ? <Text style={[styles.cardMeta, { color: C.textMuted }]}>{item.year}</Text> : null}
